...
MODS =  $D/array.o $D/format.o $D/log.o $D/hlrmisc.o $D/plabla.o \
	$D/linestream.o $D/html.o $D/common.o $D/dlist.o $D/list.o \
	$D/rbtree.o $D/rbmap.o $D/confp.o $D/numUtil.o $D/stringUtil.o $D/fasta.o \
	$D/bits.o $D/seq.o $D/geneOntology.o $D/htmlLinker.o \
	$D/intervalFind.o $D/blatParser.o $D/blastParser.o \
	$D/elandMultiParser.o $D/elandParser.o $D/bowtieParser.o \
	$D/bgrParser.o $D/exportPEParser.o

MODS_H = array.h format.h log.h hlrmisc.h plabla.h linestream.h html.h common.h \
	 dlist.h list.h rbtree.h rbmap.h confp.h types.h numUtil.h stringUtil.h \
	 fasta.h bits.h seq.h geneOntology.h htmlLinker.h intervalFind.h \
	 blatParser.h blastParser.h elandMultiParser.h elandParser.h \
	 bowtieParser.h bgrParser.h exportPEParser.h args.h
...
$D/list.o: list.c list.h types.h
	$(CC) $(CFLAGSO) list.c -c -o $D/list.o

$D/confp.o: confp.c confp.h $D/rbmap.o
	$(CC) $(CFLAGSO) $(BIOSINC) confp.c -c -o $D/confp.o

$D/rbmap.o: rbmap.c rbmap.h $D/rbtree.o
	$(CC) $(CFLAGSO) $(BIOSINC) rbmap.c -c -o $D/rbmap.o

$D/rbtree.o: rbtree.c rbtree.h types.h
	$(CC) $(CFLAGSO) rbtree.c -c -o $D/rbtree.o
...
$D/fastq.o: fastq.c fastq.h $D/log.o $D/format.o $D/linestream.o $D/seq.o $D/stringUtil.o $D/common.o
	$(CC) $(CFLAGSO) $(BIOSINC) fastq.c -c -o $D/fastq.o
